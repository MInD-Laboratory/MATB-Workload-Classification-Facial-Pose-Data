...
"""
Random Forest Models - Random Split Strategy

Runs Random Forest classifiers using stratified random 80/20 split across all windows.
Tests within-task generalization (same participants in train/test).
...
Usage:
    ...
    python run_rf_random_split.py --pose-variant procrustes_participant --dry-run
...
OUTPUT_BASE = Path("model_output") / "random_split"
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(
        description="Run Random Forest models with random split strategy",
...
def main():
    ...
    print("=" * 80)
    print("RANDOM FOREST WORKLOAD DETECTION - RANDOM SPLIT")
    print("=" * 80)
    ...
    existing_run = find_matching_run(OUTPUT_BASE, args.pose_variant, DEFAULT_MODEL_CONFIG, "random")
    ...
    save_run_settings(output_dir, args.pose_variant, DEFAULT_MODEL_CONFIG, "random")
    ...
    # Print Summary
    print("\n" + "=" * 80)
    print("✓ RF MODELS COMPLETE - RANDOM SPLIT")
    print("=" * 80)
    ...
    print("  3. Run participant split and LOPO for generalization tests")
